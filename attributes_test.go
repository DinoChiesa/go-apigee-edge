...
var (
  map1 = Attributes{"access":"private"}
  map2 = Attributes{"access":"private", "creator":"Brahma"}
  map3 = Attributes{"access":"private", "creator":"Brahma","lastModified":"Wednesday,  7 September 2016, 14:45"}
)
...
func TestAttributes_Unmarshal(t *testing.T) {
  testCases := []struct {
    ...
    {"one member   ", json1, map1, false, true},
    {"two members  ", json2, map2, false, true},
    {"three members", json3, map3, false, true},
  }
...
func TestAttributes_Marshal(t *testing.T) {
  testCases := []struct {
    ...
    {"case 1 ", map1, json1, false, true},
    {"case 2 ", map2, json2, false, true},
    {"case 3 ", map3, json3, false, true},
  }
